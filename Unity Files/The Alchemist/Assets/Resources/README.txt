...
Alchemy Pack
This folder contains some Alchemy related stuff such as models and prefabs

PowerUps:
This folder contains 3D power-ups that we can use as collectables or UI-icons.
...
Sounds:
This folder contains all the sounds made by Tarmo.

Free Sounds:
This folder contains some free sounds that we can use.
